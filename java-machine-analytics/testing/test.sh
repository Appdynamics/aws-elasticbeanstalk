...
sed -i -e "s/#APPDYNAMICS_AGENT_GLOBAL_ACCOUNT_NAME:/APPDYNAMICS_AGENT_GLOBAL_ACCOUNT_NAME: \"$APPDYNAMICS_AGENT_GLOBAL_ACCOUNT_NAME\"/" ./.ebextensions/appd.config
sed -i -e "s/#APPDYNAMICS_ANALYTICS_EVENT_ENDPOINT:/APPDYNAMICS_ANALYTICS_EVENT_ENDPOINT: \"$APPDYNAMICS_ANALYTICS_EVENT_ENDPOINT\"/" ./.ebextensions/appd.config
